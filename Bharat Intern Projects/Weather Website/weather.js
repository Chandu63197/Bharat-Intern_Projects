...
function performSearch(){
   ...
   .then(data => {
       ...
       if(descri.includes("clouds")){
            weatherbox.style.backgroundImage = "url('weather images/Cloudy.jpg')";
       }
       if(descri.includes("rain")){
            if(descri.includes("light")){
                weatherbox.style.backgroundImage = "url('weather images/LightRainShower.jpg')";
            }
            if(descri.includes("freezing")){
                weatherbox.style.backgroundImage = "url('weather images/FreezingRain.jpg')";
            }
            if(descri.includes("heavy")){
                weatherbox.style.backgroundImage = "url('weather images/HeavyRain.jpg')";
            }
            else{
                weatherbox.style.backgroundImage = "url('weather images/Rain.jpg')";
            }
       }
       if(descri.includes("drizzle")){
            weatherbox.style.backgroundImage = "url('weather images/Drizzle.jpg')";
       }
       if(descri.includes("fog") || descri.includes("haze" || descri.includes("mist"))){
            weatherbox.style.backgroundImage = "url('weather images/Fog.jpg')";
       }
       if(descri.includes("sunny")){
            if(descri.includes("mostly")){
                weatherbox.style.backgroundImage = "url('weather images/MostlySunny.jpg')";
            }
            else {
                weatherbox.style.backgroundImage = "url('weather images/Sunny.jpg')";
            }
       }
       if(descri.includes("night")){
            weatherbox.style.backgroundImage = "url('weather images/Night.jpg')";
       }
       if(descri.includes("thunder")){
            weatherbox.style.backgroundImage = "url('weather images/Thunderstorm.jpg')";
       }
       if(descri.includes("snow")){
            if(descri.includes("light")){
                weatherbox.style.backgroundImage = "url('weather images/LightSnowShower.jpg')";
            }
            else{
                weatherbox.style.backgroundImage = "url('weather images/Snow.jpg')";
            }
       }
       if(descri.includes("clear")){
            weatherbox.style.backgroundImage = "url('weather images/Clear.jpg')";
        }  
   })
...
const ImgPaths = [
    'weather images/Cloudy.jpg',
    'weather images/LightRainShower.jpg',
    'weather images/FreezingRain.jpg',
    'weather images/HeavyRain.jpg',
    'weather images/Rain.jpg',
    'weather images/Drizzle.jpg',
    'weather images/Fog.jpg',
    'weather images/MostlySunny.jpg',
    'weather images/Sunny.jpg',
    'weather images/Night.jpg',
    'weather images/Thunderstorm.jpg',
    'weather images/Snow.jpg',
    'weather images/LightSnowShower.jpg',
    'weather images/Clear.jpg'
];
